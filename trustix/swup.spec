# $Id: swup.spec.src,v 1.10 2005/08/12 13:19:45 christht Exp $
...
%files cgi
%defattr(-,root,root,0755)
%dir %attr(0755,swup,swup,0755)/home/swup/public_html/cgi-bin/
%attr(0755,swup,swup,0755)/home/swup/public_html/cgi-bin/swup_query.py
%config(noreplace) /home/swup/public_html/cgi-bin/swup_query_config.py
%config(noreplace) /etc/httpd/conf.d/swup_query.conf

%changelog
* Fri Aug 12 2005 Chr. H. Toldnes <christht at trustix dot org> 12tr
- Added -cgi sub package and swup user / group creation

* Fri Aug 12 2005 Chr. H. Toldnes <christht at trustix dot org> 11tr
- Merged swup-rdfgen and swup-libs with swup, little gain lot's of pain.

* Thu Jul 28 2005 Chr. H. Toldnes <christht at trustix dot org> 10tr
- 0711 on /etc/swup/gnupg

* Wed Jul 20 2005 Chr. H. Toldnes <christht at trustix dot org> 9tr
- gnupg should be 755 and pubring.gpg should be 644

* Fri Jul  1 2005 Chr. H. Toldnes <christht at trustix dot org> 8tr
- Better defattr
